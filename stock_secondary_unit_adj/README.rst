...
.. |badge3| image:: https://img.shields.io/badge/github-qrtl%2Fhls--custom-lightgray.png?logo=github
    :target: https://github.com/qrtl/hls-custom/tree/12.0/stock_secondary_unit_adj
    :alt: qrtl/hls-custom
...
`feedback <https://github.com/qrtl/hls-custom/issues/new?body=module:%20stock_secondary_unit_adj%0Aversion:%2012.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `qrtl/hls-custom <https://github.com/qrtl/hls-custom/tree/12.0/stock_secondary_unit_adj>`_ project on GitHub.
