...
class Pricelist(models.Model):
    ...
    # This method overide due to product pricelist will be calculated based
    # on sale commitment date
    @api.multi
    def _compute_price_rule(self, products_qty_partner, date=False, uom_id=False):
        ...
        self.ensure_one()
        if not date:
            commitment_date = self._context.get("commitment_date") or False
            date = commitment_date or self._context.get("date") or fields.Date.today()
        ...
        self._cr.execute(
            ...
            " item.min_quantity desc, categ.complete_name desc, item.id desc",
        ...
        for product, qty, partner in products_qty_partner:
            ...
            # Final unit price is computed according
            # to `qty` in the `qty_uom_id` UoM.
            ...
            # if Public user try to access standard price from
            # website sale, need to call price_compute.
            ...
            for rule in items:
                ...
                if rule.base == "pricelist" and rule.base_pricelist_id:
                    ...
                    # if base option is public price take sale
                    # price else cost price of product
                    # price_compute returns the price in the
                    # context UoM, i.e. qty_uom_id
                    price = product.price_compute(rule.base)[product.id]

                convert_to_price_uom = product.uom_id._compute_price(price, price_uom)
